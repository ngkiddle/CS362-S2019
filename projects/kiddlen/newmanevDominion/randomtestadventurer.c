...
void randomAdventurerTest(){
    ...
    for(int i = 0; i < 10000; i++){
        ...
        printf("______________________________TEST (adventurerEffect) First Player__________________________________\n");
            ...
            adventurerCardEffect(&g, 0, currentPlayer, z);
            //printState(&g, players);
            int t = assert(gInit.deckCount[currentPlayer], g.deckCount[currentPlayer]);
            if (t != 1){
                printf("PASSED: changes were made to current players deck.\n");
            }
            else{
            ...
            if (t != 1){
                printf("PASSED: changes were made to current players hand.\n");
            }
            else{
                printf("FAILED: no changes were made to state.\n");
            }
            ...
            if (t != 1){
                printf("PASSED: changes were made to players discardCount.\n");
            }
            else{
                printf("FAILED: no changes were made to state.\n");
            }
            ...
            if (t == 1){
                ...
                printf("FAILED: changes were made to state.\n");
            }
            //////////////
