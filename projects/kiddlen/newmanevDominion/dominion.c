...
int villageCardEffect(int currentPlayer, struct gameState * state, int handPos) {
  ...
  //+1 Card
  //BUG should be: no for loop for drawCard
  for (int i = 0; i < 2; i++) {
...
int adventurerCardEffect(struct gameState* state, int drawntreasure, int currentPlayer, int z) {
...
int greathallCardEffect(struct gameState * state, int handPos, int currentPlayer) {
...
int outpostCardEffect(struct gameState * state, int handPos, int currentPlayer) {
  //set outpost flag
  state->outpostPlayed++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState * state, int handPos, int * bonus) {
  ...
  switch (card) {
    case adventurer:
      return adventurerCardEffect(state, drawntreasure, currentPlayer, z);
    ...
    case great_hall:
      greathallCardEffect(state, handPos, currentPlayer);
    ...
    case outpost:
      return outpostCardEffect(state, handPos, currentPlayer);
